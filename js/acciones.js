...
$(document).ready(function(e){	
    ...
    $('#principal').height($('#page').height());
     document.addEventListener("deviceready",function(){
		 ...
		 audio=window.plugins.LowLatencyAudio; // precargar el audio
		 audio.preloadFX('do','audio/DO.mp3',function(){},function(e){alert('Error '+e);});                       //alias,donde esta ubicado,que hacer si se carga, si no se carga 
